...
public final class FragmentCleanDomainBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCleanDomainBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentCleanDomainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCleanDomainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_clean_domain, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCleanDomainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCleanDomainBinding((ConstraintLayout) rootView, ConstraintLayout, btn01,
