...
public final class FragmentCleanMvvmBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentCleanMvvmBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentCleanMvvmBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentCleanMvvmBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_clean_mvvm, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentCleanMvvmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCleanMvvmBinding((ConstraintLayout) rootView, ConstraintLayout, btn01,
