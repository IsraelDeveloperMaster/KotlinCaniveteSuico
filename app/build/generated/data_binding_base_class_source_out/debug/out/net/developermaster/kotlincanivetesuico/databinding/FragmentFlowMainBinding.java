...
public final class FragmentFlowMainBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFlowMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentFlowMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFlowMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_flow_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFlowMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFlowMainBinding((ConstraintLayout) rootView, btn01, btn02, btn03,
