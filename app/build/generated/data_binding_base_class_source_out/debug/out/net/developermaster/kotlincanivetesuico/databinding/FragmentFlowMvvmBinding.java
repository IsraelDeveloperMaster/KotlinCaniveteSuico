...
public final class FragmentFlowMvvmBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFlowMvvmBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentFlowMvvmBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFlowMvvmBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_flow_mvvm, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFlowMvvmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFlowMvvmBinding((ConstraintLayout) rootView, btn01, btn02, btn03,
