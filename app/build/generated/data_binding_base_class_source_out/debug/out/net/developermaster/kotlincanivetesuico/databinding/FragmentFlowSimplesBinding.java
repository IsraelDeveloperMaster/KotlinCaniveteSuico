...
public final class FragmentFlowSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentFlowSimplesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentFlowSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentFlowSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_flow_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentFlowSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFlowSimplesBinding((ConstraintLayout) rootView, btn01, fabCodigo, fabXml,
