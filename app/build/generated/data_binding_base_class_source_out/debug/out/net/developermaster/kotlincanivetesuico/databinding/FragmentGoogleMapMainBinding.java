...
public final class FragmentGoogleMapMainBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentGoogleMapMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentGoogleMapMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_google_map_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentGoogleMapMainBinding bind(@NonNull View rootView) {
