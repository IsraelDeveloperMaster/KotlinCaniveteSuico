...
public final class FragmentHiltDependenciasNomeadasBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHiltDependenciasNomeadasBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentHiltDependenciasNomeadasBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHiltDependenciasNomeadasBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_hilt_dependencias_nomeadas, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHiltDependenciasNomeadasBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHiltDependenciasNomeadasBinding((ConstraintLayout) rootView,
          ConstraintLayout, btn01, fabCodigo, fabXml, progressBar, textView, textView2, textView3);
    }
