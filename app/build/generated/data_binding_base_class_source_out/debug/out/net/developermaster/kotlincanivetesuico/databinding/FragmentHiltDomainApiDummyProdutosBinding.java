...
public final class FragmentHiltDomainApiDummyProdutosBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHiltDomainApiDummyProdutosBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentHiltDomainApiDummyProdutosBinding inflate(
      @NonNull LayoutInflater inflater) {
    return inflate(inflater, null, false);
  }

  @NonNull
  public static FragmentHiltDomainApiDummyProdutosBinding inflate(@NonNull LayoutInflater inflater,
      @Nullable ViewGroup parent, boolean attachToParent) {
    View root = inflater.inflate(R.layout.fragment_hilt_domain_api_dummy_produtos, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHiltDomainApiDummyProdutosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHiltDomainApiDummyProdutosBinding((ConstraintLayout) rootView,
