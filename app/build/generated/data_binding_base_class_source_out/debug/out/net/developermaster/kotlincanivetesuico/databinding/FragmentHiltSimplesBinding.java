...
public final class FragmentHiltSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentHiltSimplesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentHiltSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentHiltSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_hilt_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentHiltSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentHiltSimplesBinding((ConstraintLayout) rootView, btn01, fabCodigo, fabXml,
          progressBar, progressBar2, textView);
    }
