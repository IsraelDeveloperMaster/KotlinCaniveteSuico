...
public final class FragmentLivedataSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentLivedataSimplesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentLivedataSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentLivedataSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_livedata_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentLivedataSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLivedataSimplesBinding((ConstraintLayout) rootView, btn01, btn02,
