...
public final class FragmentMvpApiBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMvpApiBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMvpApiBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMvpApiBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_mvp_api, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMvpApiBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMvpApiBinding((ConstraintLayout) rootView, ConstraintLayout, btn01,
