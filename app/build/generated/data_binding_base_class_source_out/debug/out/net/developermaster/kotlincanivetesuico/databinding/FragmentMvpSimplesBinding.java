...
public final class FragmentMvpSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentMvpSimplesBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentMvpSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentMvpSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_mvp_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentMvpSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentMvpSimplesBinding((ConstraintLayout) rootView, ConstraintLayout, btn01,
          fabCodigo, fabXml, textView);
    }
