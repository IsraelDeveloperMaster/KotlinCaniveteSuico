...
public final class FragmentPadraoBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentPadraoBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentPadraoBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentPadraoBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_padrao, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentPadraoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPadraoBinding((ConstraintLayout) rootView, btn01, btn02, btn03, fabCodigo,
