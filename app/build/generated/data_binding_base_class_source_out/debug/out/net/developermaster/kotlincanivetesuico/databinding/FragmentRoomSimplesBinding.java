...
public final class FragmentRoomSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentRoomSimplesBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnAtualizar, @NonNull Button btnDeletar, @NonNull Button btnListaId,
  ...
  @NonNull
  public static FragmentRoomSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentRoomSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_room_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentRoomSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentRoomSimplesBinding((ConstraintLayout) rootView, btnAtualizar, btnDeletar,
          btnListaId, btnListaIdade, btnListaNome, btnListaTodos, btnSalvar, fabCodigo, fabXml,
          layoutVertical01, linhaGuiaVertical, progressBar, textInputId, textInputIdLayout,
