...
public final class FragmentServicesBackgroundMainBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentServicesBackgroundMainBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentServicesBackgroundMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentServicesBackgroundMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_services_background_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentServicesBackgroundMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentServicesBackgroundMainBinding((ConstraintLayout) rootView, btn01, btn02,
          btn03, fabCodigo, fabXml, progressBar);
    }
