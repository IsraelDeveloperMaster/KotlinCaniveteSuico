...
public final class FragmentServicesForegroundSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentServicesForegroundSimplesBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentServicesForegroundSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentServicesForegroundSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_services_foreground_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentServicesForegroundSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentServicesForegroundSimplesBinding((ConstraintLayout) rootView, btn01, btn02,
