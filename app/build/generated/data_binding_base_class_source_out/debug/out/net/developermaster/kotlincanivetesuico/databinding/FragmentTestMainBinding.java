...
public final class FragmentTestMainBinding implements ViewBinding {
  ...
  private FragmentTestMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentTestMainBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentTestMainBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_test_main, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentTestMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentTestMainBinding((ConstraintLayout) rootView, btn01, btn02, fabCodigo,
          fabXml, progressBar);
    }
