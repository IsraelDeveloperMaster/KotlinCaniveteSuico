...
public final class FragmentViewmodelSimplesBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentViewmodelSimplesBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn01,
  ...
  @NonNull
  public static FragmentViewmodelSimplesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentViewmodelSimplesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_viewmodel_simples, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentViewmodelSimplesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentViewmodelSimplesBinding((ConstraintLayout) rootView, btn01, fabCodigo,
