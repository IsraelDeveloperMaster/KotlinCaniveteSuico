package net.developermaster.kotlincanivetesuico.ui.Room.RoomMVVM.DataBase;
...
import net.developermaster.kotlincanivetesuico.ui.Room.RoomMVVM.Dao.InterfaceDaoRoomMVVM;
import net.developermaster.kotlincanivetesuico.ui.Room.RoomMVVM.Dao.InterfaceDaoRoomMVVM_Impl;

@SuppressWarnings({"unchecked", "deprecation"})
public final class BancoDeDadosRoomMVVM_Impl extends BancoDeDadosRoomMVVM {
  private volatile InterfaceDaoRoomMVVM _interfaceDaoRoomMVVM;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoNomeDaTabela.equals(_existingNomeDaTabela)) {
          return new RoomOpenHelper.ValidationResult(false, "nome_da_tabela(net.developermaster.kotlincanivetesuico.ui.Room.RoomMVVM.ModelEntidades.ClasseDeDadosEntidadeRoomMVVM).\n"
                  + " Expected:\n" + _infoNomeDaTabela + "\n"
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(InterfaceDaoRoomMVVM.class, InterfaceDaoRoomMVVM_Impl.getRequiredConverters());
  ...
  @Override
  public InterfaceDaoRoomMVVM classeDaoRoomMVVM() {
    if (_interfaceDaoRoomMVVM != null) {
      return _interfaceDaoRoomMVVM;
    } else {
      synchronized(this) {
        if(_interfaceDaoRoomMVVM == null) {
          _interfaceDaoRoomMVVM = new InterfaceDaoRoomMVVM_Impl(this);
        }
        return _interfaceDaoRoomMVVM;
      }
    }
