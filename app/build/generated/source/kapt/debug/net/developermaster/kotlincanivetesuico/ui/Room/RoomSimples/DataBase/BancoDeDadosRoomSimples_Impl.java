package net.developermaster.kotlincanivetesuico.ui.Room.RoomSimples.DataBase;
...
import net.developermaster.kotlincanivetesuico.ui.Room.RoomSimples.Dao.InterfaceDaoRoomSimples_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoNomeDaTabela.equals(_existingNomeDaTabela)) {
          return new RoomOpenHelper.ValidationResult(false, "nome_da_tabela(net.developermaster.kotlincanivetesuico.ui.Room.RoomSimples.ModelEntidade.ClasseDeDadosEntidadeRoomSimples).\n"
                  + " Expected:\n" + _infoNomeDaTabela + "\n"
