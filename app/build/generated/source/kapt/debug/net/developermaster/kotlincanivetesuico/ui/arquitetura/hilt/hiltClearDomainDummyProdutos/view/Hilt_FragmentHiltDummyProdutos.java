 ...
 */
public abstract class Hilt_FragmentHiltDummyProdutos extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHiltDummyProdutos() {
    super();
  }

  Hilt_FragmentHiltDummyProdutos(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHiltDummyProdutos_GeneratedInjector) this.generatedComponent()).injectFragmentHiltDummyProdutos(UnsafeCasts.<FragmentHiltDummyProdutos>unsafeCast(this));
    }
  }
