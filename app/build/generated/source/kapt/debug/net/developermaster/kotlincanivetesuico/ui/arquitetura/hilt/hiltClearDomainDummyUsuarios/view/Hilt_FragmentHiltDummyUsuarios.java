 ...
 */
public abstract class Hilt_FragmentHiltDummyUsuarios extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHiltDummyUsuarios() {
    super();
  }

  Hilt_FragmentHiltDummyUsuarios(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHiltDummyUsuarios_GeneratedInjector) this.generatedComponent()).injectFragmentHiltDummyUsuarios(UnsafeCasts.<FragmentHiltDummyUsuarios>unsafeCast(this));
    }
  }
