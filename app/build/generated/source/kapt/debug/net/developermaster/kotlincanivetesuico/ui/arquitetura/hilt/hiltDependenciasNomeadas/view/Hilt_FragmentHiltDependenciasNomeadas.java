 ...
 */
public abstract class Hilt_FragmentHiltDependenciasNomeadas extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHiltDependenciasNomeadas() {
    super();
  }

  Hilt_FragmentHiltDependenciasNomeadas(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHiltDependenciasNomeadas_GeneratedInjector) this.generatedComponent()).injectFragmentHiltDependenciasNomeadas(UnsafeCasts.<FragmentHiltDependenciasNomeadas>unsafeCast(this));
    }
  }
