 ...
 */
public abstract class Hilt_FragmentHiltInjecao extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHiltInjecao() {
    super();
  }

  Hilt_FragmentHiltInjecao(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHiltInjecao_GeneratedInjector) this.generatedComponent()).injectFragmentHiltInjecao(UnsafeCasts.<FragmentHiltInjecao>unsafeCast(this));
    }
  }
