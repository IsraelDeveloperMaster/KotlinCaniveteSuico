 ...
 */
public abstract class Hilt_FragmentHiltSimples extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentHiltSimples() {
    super();
  }

  Hilt_FragmentHiltSimples(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentHiltSimples_GeneratedInjector) this.generatedComponent()).injectFragmentHiltSimples(UnsafeCasts.<FragmentHiltSimples>unsafeCast(this));
    }
  }
