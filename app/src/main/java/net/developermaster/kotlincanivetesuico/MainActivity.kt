...
class MainActivity : AppCompatActivity()  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     /*   binding.appBarMain.fab.setOnClickListener { view ->
        ...
        appBarConfiguration = AppBarConfiguration(setOf( R.id.fragment_Arquitetura_Main, R.id.fragment_SearchView_Main, R.id.fragment_Home, R.id.fragment_SearchView_Main, R.id.fragment_FireBase_Main ), drawerLayout)
