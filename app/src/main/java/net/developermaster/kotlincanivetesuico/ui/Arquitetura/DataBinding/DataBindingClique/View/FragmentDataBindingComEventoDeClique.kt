...
import net.developermaster.kotlincanivetesuico.ui.Arquitetura.DataBinding.DataBindingClique.Model.ClasseViewModelDataBindingComEventoDeClique
import net.developermaster.kotlincanivetesuico.ui.Arquitetura.DataBinding.DataBindingClique.Model.DadoDeReferenciaDoXmlBindingComEventoDeClique
...
class FragmentDataBindingComEventoDeClique : Fragment()  {
    ...
    private lateinit var classeViewModelComEventoDeClique: ClasseViewModelDataBindingComEventoDeClique
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dadoDeReferenciaDoXml = DadoDeReferenciaDoXmlBindingComEventoDeClique ( "Julia" , "25" )

        //todo instanciando viewmodel
        this.classeViewModelComEventoDeClique = ViewModelProvider( this ).get(  ClasseViewModelDataBindingComEventoDeClique::class.java )
