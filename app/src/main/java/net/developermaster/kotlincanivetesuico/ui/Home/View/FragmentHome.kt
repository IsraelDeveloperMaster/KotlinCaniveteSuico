...
class FragmentHome : Fragment() , InterfaceHome {
    ...
    private lateinit var classeDeDadosHome: List<ClasseDeDadosHome> 
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        classeDeDadosHome = listOf(

            ClasseDeDadosHome(getString(R.string.EXT_COMPOSE) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_FIREBASE) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_ROOM) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_SEARCHVIEW) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_MVC) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_MVP) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_VIEWMODEL) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_LIVEDATA) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_DATABINDING) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_MVVM) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_CLEAN_ARCHITECTURE) , R.drawable.java),
            ClasseDeDadosHome(getString(R.string.EXT_HILT) , R.drawable.java)
        )

        // Configura a RecyclerView
        recyclerView = binding.recyclerview
        recyclerView.layoutManager = LinearLayoutManager(context)
        adapter = AdapterHome(classeDeDadosHome, this)
