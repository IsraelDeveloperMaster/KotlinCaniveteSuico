package net.developermaster.classe_de_dados_codigos
...
import net.developermaster.classe_de_dados_codigos.databinding.FragmentCodigoBinding

class FragmentCodigos : Fragment(){
